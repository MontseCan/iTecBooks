<template>
  <div>
    ...
    <div class="app-content-page">
      ...
      >
        <el-form-item
          :label="fields.loanPeriodInDay.label"
          :prop="fields.loanPeriodInDay.name"
          :required="fields.loanPeriodInDay.required"
        >
          <el-col :lg="11" :md="16" :sm="24">
            <el-input-number
              :precision="0"
              :step="1"
              v-model="model[fields.loanPeriodInDay.name]"
            >
            </el-input-number>
          </el-col>
        </el-form-item>
