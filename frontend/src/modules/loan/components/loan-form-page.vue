<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>
        <app-i18n
          code="entities.loan.edit.title"
          v-if="isEditing"
        ></app-i18n>
        <app-i18n
          code="entities.loan.new.title"
          v-if="!isEditing"
        ></app-i18n>
      </el-breadcrumb-item>
    </el-breadcrumb>
...
const ediFormSchema = new FormSchema([
  fields.id,
  fields.book,
  fields.member,
  fields.issueDate,
...
export default {
  ...
  computed: {
    ...
    formSchema() {
      return this.isEditing ? ediFormSchema : newFormSchema;
    },
  ...
  methods: {
    ...
    onReturnDateChange(value) {
      this.fillStatus(this.model.returnDate, value);
    },
